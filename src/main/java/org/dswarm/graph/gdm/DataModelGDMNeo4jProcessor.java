...
public class DataModelGDMNeo4jProcessor extends GDMNeo4jProcessor {
	...
	public DataModelGDMNeo4jProcessor(final GraphDatabaseService database, final NamespaceIndex namespaceIndex, final String dataModelURIArg) throws DMPGraphException {
