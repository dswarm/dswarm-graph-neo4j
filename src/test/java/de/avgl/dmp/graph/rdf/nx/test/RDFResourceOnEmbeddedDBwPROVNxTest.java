...
public class RDFResourceOnEmbeddedDBwPROVNxTest extends EmbeddedNeo4jTest {

	private static final Logger	LOG	= LoggerFactory.getLogger(RDFResourceOnEmbeddedDBwPROVNxTest.class);
