...
public class RDFResourceOnRunningDBNxTest extends RunningNeo4jTest {

	private static final Logger	LOG	= LoggerFactory.getLogger(RDFResourceOnRunningDBNxTest.class);
