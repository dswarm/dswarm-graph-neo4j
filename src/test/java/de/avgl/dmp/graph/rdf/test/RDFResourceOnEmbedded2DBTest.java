...
public class RDFResourceOnEmbedded2DBTest extends EmbeddedNeo4jTest {

	private static final Logger	LOG	= LoggerFactory.getLogger(RDFResourceOnEmbedded2DBTest.class);
